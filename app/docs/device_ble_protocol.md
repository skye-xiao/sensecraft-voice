...
> **Canonical protocol reference** lives in the SDK repository:
> [`sensecraft-voice/docs/DEVICE_BLE_PROTOCOL.md`](../../sensecraft-voice/docs/DEVICE_BLE_PROTOCOL.md)
>
...
`sensecraft_voice` package (`path: ../sensecraft-voice`). Update protocol
