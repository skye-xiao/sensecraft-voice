...
| BLE UUIDs, AT command table, JSON conventions, WiFi AT | [sensecraft-voice/docs/DEVICE_BLE_PROTOCOL.md](../../sensecraft-voice/docs/DEVICE_BLE_PROTOCOL.md)（App 侧 [device_ble_protocol.md](device_ble_protocol.md) 为跳转） |
...
| **国内 Android 上架：隐私弹窗、隐藏第三方登录、如何 run/build** | [china_android_store.md](china_android_store.md) |
| **App 自测用例清单（Excel/CSV）** | [APP_SELF_TEST_CHECKLIST.csv](APP_SELF_TEST_CHECKLIST.csv) |
...
| Doc | Description |
|-----|-------------|
| [device_ble_protocol.md](device_ble_protocol.md) | 跳转至 SDK 协议文档 |
