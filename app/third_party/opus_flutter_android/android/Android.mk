...
# Align ELF LOAD segments to 16KB so libopus.so works on Android 15+ (API 35)
# devices using 16KB memory pages (required by Google Play from 2025-11).
# Upstream opus_flutter_android 3.0.1 omits this; see EPNW/opus_flutter PR #28.
